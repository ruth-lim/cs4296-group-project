...
for TEST in "${TEST_NAMES[@]}"; do
  JMX_FILE="test/gcp/${TEST}_test_plan.jmx"
  CSV_OUTPUT="results/gcp/${TEST}_results.csv"
  HTML_OUTPUT_DIR="results/gcp/${TEST}_html"
...
echo "Reports generated. Check the results/gcp/ directory."