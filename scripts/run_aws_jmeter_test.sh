...
for TEST in "${TEST_NAMES[@]}"; do
  JMX_FILE="test/aws/${TEST}_test_plan.jmx"
  CSV_OUTPUT="results/aws/${TEST}_results.csv"
  HTML_OUTPUT_DIR="results/aws/${TEST}_html"
...
echo "Reports generated. Check the results/aws/ directory."